...
ThreatsObject::ThreatsObject() 
{
  ...
  input_type_.left_ = 0; // Ban đầu không di chuyển qua trái
}

ThreatsObject::~ThreatsObject() // Giải phóng bộ nhớ viên đạn đã được bắn ra 
{
...
void ThreatsObject::InitPlayer() // Khởi tạo lại địch khi chết
{
